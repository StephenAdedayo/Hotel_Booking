...
const Navbar = () => {
    ...
    useEffect(() => {
        ...
        // if location is not homepage the white background of the nav will be shown because isScrolled is now true else false
        ...
        // setIsScrolled to prev value except when location is not "/", it should be true else prev value
    ...
    return (
       ...
       {/* once there is a user it shows a dropdown that has menu items and a userbutton.action is added to provide more options */}
                 {user ? (<UserButton>
