       ...
       {bookings.map((booking) => (
        <div className='grid grid-cols-1 md:grid-cols-[3fr_2fr_1fr] w-full border-b border-gray-300 py-6 first:border-t '>
            ...
            <div className='flex flex-col items-start justify-center pt-3'>
              ...
              {!booking.isPaid && (
                <button onClick={() => handlePayment(booking._id)} className='px-4 cursor-pointer py-1.5 mt-4 text-xs border border-gray-400 rounded-full hover:bg-gray-50 transition-all'>Pay Now</button>
              )}
            </div>
        </div>
       ))}
